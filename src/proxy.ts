...
//   // not public route → check session
//   if (!session || !session.user) {
//     console.warn("🚫 No session or user, redirecting to login");
//     const loginUrl = new URL("/login", request.url);
//     loginUrl.searchParams.set("callbackUrl", pathname);
//     return NextResponse.redirect(loginUrl);
//   }
...
//     console.error("❌ User role missing in session, redirecting to login");
//     const loginUrl = new URL("/login", request.url);
//     loginUrl.searchParams.set("callbackUrl", pathname);
//     return NextResponse.redirect(loginUrl);
//   }
...
//   if (pathname.startsWith("/student") && role !== "STUDENT") {
//     console.warn(`🚫 Access denied. Required: STUDENT, Your role: ${role}`);
//     return NextResponse.redirect(new URL("/unauthorized", request.url));
//   }

//   if (pathname.startsWith("/tutor") && role !== "TUTOR") {
//     console.warn(`🚫 Access denied. Required: TUTOR, Your role: ${role}`);
//     return NextResponse.redirect(new URL("/unauthorized", request.url));
//   }

//   if (pathname.startsWith("/admin") && role !== "ADMIN") {
//     console.warn(`🚫 Access denied. Required: ADMIN, Your role: ${role}`);
//     return NextResponse.redirect(new URL("/unauthorized", request.url));
//   }
